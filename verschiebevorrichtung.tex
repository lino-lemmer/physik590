% Tikzpicture Verschiebevorrichtung
    \begin{tikzpicture}
        ...
        % Druckausgleich
            ...
            \draw (13.,-3) rectangle node {6} (13.75,-2);

            \draw[double] (12,-.2) to [out=180, in=180] (13,-2.3);
            \draw[double] (11.5,.3) to [out=-90, in=180] (13,-2.4); 
            \draw[double](13.3,.9) to [out=-90, in=180] (13,-2.2);

        % Wanne

            \draw (8.5,-1.9) rectangle (15.5,2);
            \draw (15.3,1.8) -- (15.5,2.4) node[above] {7};

        % Aufteilung Kontroll-/MRT-Raum

            \draw[dashed, thick] (8.4,-3) -- (8.4,5.3) ;

            \node[left] (kontroll) at (8.0,5) {Kontrollraum};
            \node[right] (MRT) at (8.8,5) {MRT-Raum};

        % Beschriftung
        \node at (1,4) {\parbox{5.5cm}{
                1: Schrittmotor \\
                2: Steckverbindung \\
