...
daher spricht man auch von \emph{Schallstrahlungskraft}. Diese ist zur
Intensität und zu Absorbtion im Gewebe proportional.
...
\[
    N = \frac{D^2}{4\lambda},
\]
mit dem Durchmesser $D$ des Emitters und der emittierten Wellenlänge
$\lambda$. Dieser Abstand kann durch den Einsatz einer Linse verringert
werden.
...
Da in der Wand zwischen Kontroll- und MRT-Raum nur zwei elektromagnetisch
abgeschirmte Bohrungen mit \SI{50}{\milli\meter} Durchmesser zu Verfügung
stehen, sind die Schläuche mit tropffreien Kupplungen versehen. Um dennoch
eine Wiederbefüllung zu ermöglichen gibt es an jedem Schlauch noch eine
einfache Steckverbindung, die nach der Befüllung nicht mehr gelöst wird.
...
\end{figure}
    ...
    werden. In einer Studie soll an Brustkrebspatientinnen mit gesichertem
    ...
    benutzen. Öl hätte hier zum Beispiel den Vorteil, dass, wegen
    schlechter Löslichkeit von Luft, Bläschenbildung kein Problem mehr 
    wäre.
    ...
    Zuallererst möchte ich mich bei Herrn Professor Dr. Karl Maier
    bedanken. Seine Art einen großen Erfahrungsschatz mit seiner
    Umgebung zu teilen ist unvergleichlich und hat mich überhaupt erst
    dazu bewegt, mich mit diesem interessanten Thema zu befassen.
    Zudem bedanke ich mich für seinen großen Einsatz, der dafür
    sorgt, dass er auch noch abends zur Uni fährt, um seine Ideen
    umzusetzen.

    Herrn Professor Dr. Carsten Urbach danke ich dafür, dass er trotz
    eines engen Zeitplanes Zeit für die Co-Korrektur meine Arbeit
    findet.

    Für ein großartiges Arbeitsklima möchte ich mich bei meiner
    gesamten Arbeitsgruppe, Judith Wild, Anna-Lisa Kofahl, Sebastian
    Theilenberg, Jakob Bindl, Sylvia Napiletzki, Niels Räth, Björn
    Schemmann, Birgit Schu-Schätter, Deniz Ulucay, Pascal
    Neumeister, Roberto Correa-Schragen und Alexandra Vohlen
    bedanken. Beim gemeinsamen Mittag- und Kuchenessen sowie bei den
    hochinteressanten Freitags-Symposien habe ich mich von Anfang an als
    Teil der Gruppe gefühlt. Besonders Judith bin ich für das
    Korrekturlesen dieser Arbeit und die gute Betreuung während der
    gesamten Durchführung zu großem Dank verpflichtet.

    Ich danke Herrn Habenstein für seine Hilfe bei der Konstruktion von
    Bauteilen und für seinen Ratschläge, die meine Arbeit erheblich
    vereinfacht haben. 

    Mein Dank geht auch an Herrn Klaes und alle Mitarbeiter der
    Feinmechanikwerkstatt, sowie an die Damen und Herren der
    Verwaltung.

    Zu guter Letzt danke ich meiner Frau und meiner restlichen
    Familie für die Unterstützung und Motivation während meines
    gesamten bisherigen Studiums, sowie meinen Freunden, allen voran
    Martin Ueding für die Hilfe beim Anfertigen und das
